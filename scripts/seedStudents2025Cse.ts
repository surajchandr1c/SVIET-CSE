...
import students from "../data/students2025Cse.json";
...
const main = async () => {
  ...
  console.log(`Seeded ${rows.length} 2025 CSE students.`);
  console.log(
    `Verified database count: ${await Student.countDocuments({ semester: 2, course: "CSE", admissionNo: /^2025/ })}`
  );
